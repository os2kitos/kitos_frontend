describe('it-system-usage', () => {
  ...
  it('Can deactivate and delete notifications', () => {
    ...
    cy.getByDataCy('confirm-dialog').within(() => {
      cy.intercept('PATCH', '/api/v2/internal/notifications/ItSystemUsage/85cc6bd8-da66-4d4e-8e56-4dbc16e5c109/scheduled/deactivate/310ea75c-1111-4bcd-1111-a19543b0dcc5',
  ...
  it('Can add notification', () => {
    ...
    cy.getByDataCy('notifications-dialog').should('be.visible').within(() => {
      ...
      cy.intercept('POST', '/api/v2/internal/notifications/ItSystemUsage/85cc6bd8-da66-4d4e-8e56-4dbc16e5c109/immediate',
        { fixture: './it-system-usage/notifications/it-system-usage-post-notification.json' })
        .as('postNewNotification')
      cy.getByDataCy('confirm-button').click()
      ...
      cy.wait('@postNewNotification').its('response.body').then(body => {
