...
cleanup_swagger() {
  replace_proxy "http://localhost:44300" "https://kitos-dev\\.strongminds\\.dk" "openapitools.json"
}
...
if [ "$1" = "start" ]; then
 ...
 if [ "$1" = "swagger" ]; then
   ...
   replace_proxy "https://kitos-dev\\.strongminds\\.dk" "http://localhost:44300" "openapitools.json"
   yarn swagger
 fi
