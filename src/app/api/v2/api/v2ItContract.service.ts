...
export class APIV2ItContractService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public pATCHItContractV2PatchItContractUpdateContractRequestDTORequestGuidContractUuidByContractuuid(contractUuid: string, request: APIUpdateContractRequestDTO, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<APIItContractResponseDTO>;
    public pATCHItContractV2PatchItContractUpdateContractRequestDTORequestGuidContractUuidByContractuuid(contractUuid: string, request: APIUpdateContractRequestDTO, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<APIItContractResponseDTO>>;
    ...
    public pATCHItContractV2PatchItContractUpdateContractRequestDTORequestGuidContractUuidByContractuuid(contractUuid: string, request: APIUpdateContractRequestDTO, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        if (contractUuid === null || contractUuid === undefined) {
            throw new Error('Required parameter contractUuid was null or undefined when calling pATCHItContractV2PatchItContractUpdateContractRequestDTORequestGuidContractUuidByContractuuid.');
        }
        if (request === null || request === undefined) {
            throw new Error('Required parameter request was null or undefined when calling pATCHItContractV2PatchItContractUpdateContractRequestDTORequestGuidContractUuidByContractuuid.');
        }
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public pUTItContractV2PutItContractUpdateContractRequestDTORequestGuidContractUuidByContractuuid(contractUuid: string, request: APIUpdateContractRequestDTO, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<APIItContractResponseDTO>;
    public pUTItContractV2PutItContractUpdateContractRequestDTORequestGuidContractUuidByContractuuid(contractUuid: string, request: APIUpdateContractRequestDTO, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<APIItContractResponseDTO>>;
    public pUTItContractV2PutItContractUpdateContractRequestDTORequestGuidContractUuidByContractuuid(contractUuid: string, request: APIUpdateContractRequestDTO, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<APIItContractResponseDTO>>;
    public pUTItContractV2PutItContractUpdateContractRequestDTORequestGuidContractUuidByContractuuid(contractUuid: string, request: APIUpdateContractRequestDTO, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        if (contractUuid === null || contractUuid === undefined) {
            throw new Error('Required parameter contractUuid was null or undefined when calling pUTItContractV2PutItContractUpdateContractRequestDTORequestGuidContractUuidByContractuuid.');
        }
        if (request === null || request === undefined) {
            throw new Error('Required parameter request was null or undefined when calling pUTItContractV2PutItContractUpdateContractRequestDTORequestGuidContractUuidByContractuuid.');
        }
