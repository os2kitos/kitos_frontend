...
export class APIV2ItContractPaymentFrequencyTypeService {
    ...
    public gETItContractPaymentFrequencyTypeV2GetGuidOrganizationUuidGuidPaymentFrequencyTypeUuidByPaymentfrequencytypeuuid(paymentFrequencyTypeUuid: string, organizationUuid: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        if (paymentFrequencyTypeUuid === null || paymentFrequencyTypeUuid === undefined) {
            throw new Error('Required parameter paymentFrequencyTypeUuid was null or undefined when calling gETItContractPaymentFrequencyTypeV2GetGuidOrganizationUuidGuidPaymentFrequencyTypeUuidByPaymentfrequencytypeuuid.');
        }
        if (organizationUuid === null || organizationUuid === undefined) {
            throw new Error('Required parameter organizationUuid was null or undefined when calling gETItContractPaymentFrequencyTypeV2GetGuidOrganizationUuidGuidPaymentFrequencyTypeUuidByPaymentfrequencytypeuuid.');
        }
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public gETItContractPaymentFrequencyTypeV2GetUnboundedPaginationQueryPaginationGuidOrganizationUuid(organizationUuid: string, page?: number, pageSize?: number, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<Array<APIRegularOptionResponseDTO>>;
    public gETItContractPaymentFrequencyTypeV2GetUnboundedPaginationQueryPaginationGuidOrganizationUuid(organizationUuid: string, page?: number, pageSize?: number, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<Array<APIRegularOptionResponseDTO>>>;
    public gETItContractPaymentFrequencyTypeV2GetUnboundedPaginationQueryPaginationGuidOrganizationUuid(organizationUuid: string, page?: number, pageSize?: number, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<Array<APIRegularOptionResponseDTO>>>;
