...
export interface APIV2DataProcessingRegistrationOversightTypeServiceInterface {
     ...
     */
    gETDataProcessingRegistrationOversightTypeV2GetGuidOrganizationUuidUnboundedPaginationQueryPagination(organizationUuid: string, page?: number, pageSize?: number, extraHttpRequestParams?: any): Observable<Array<IdentityNamePairResponseDTO>>;
     ...
     * @param organizationUuid organization context for the oversight availability
     */
    gETDataProcessingRegistrationOversightTypeV2GetGuidOversightUuidGuidOrganizationUuidByOversightuuid(oversightUuid: string, organizationUuid: string, extraHttpRequestParams?: any): Observable<RegularOptionExtendedResponseDTO>;
