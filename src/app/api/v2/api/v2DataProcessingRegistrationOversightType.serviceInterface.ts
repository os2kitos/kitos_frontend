...
export interface APIV2DataProcessingRegistrationOversightTypeServiceInterface {
     ...
     */
    gETDataProcessingRegistrationOversightTypeV2GetGuidOrganizationUuidGuidOversightUuid(oversightUuid: string, organizationUuid: string, extraHttpRequestParams?: any): Observable<APIRegularOptionExtendedResponseDTO>;
     ...
     */
    gETDataProcessingRegistrationOversightTypeV2GetUnboundedPaginationQueryPaginationGuidOrganizationUuid(organizationUuid: string, page?: number, pageSize?: number, extraHttpRequestParams?: any): Observable<Array<APIIdentityNamePairResponseDTO>>;
