...
export interface APIV2ItContractContractTemplateTypeServiceInterface {
     ...
     */
    gETItContractContractTemplateTypeV2GetGuidContractTemplateTypeUuidGuidOrganizationUuidByContracttemplatetypeuuid(contractTemplateTypeUuid: string, organizationUuid: string, extraHttpRequestParams?: any): Observable<RegularOptionExtendedResponseDTO>;
     ...
     */
    gETItContractContractTemplateTypeV2GetGuidOrganizationUuidUnboundedPaginationQueryPagination(organizationUuid: string, page?: number, pageSize?: number, extraHttpRequestParams?: any): Observable<Array<IdentityNamePairResponseDTO>>;
