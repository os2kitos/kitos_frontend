...
export interface APIV2ItContractNoticePeriodMonthTypeServiceInterface {
     ...
     */
    gETItContractNoticePeriodMonthTypeV2GetGuidOrganizationUuidUnboundedPaginationQueryPagination(organizationUuid: string, page?: number, pageSize?: number, extraHttpRequestParams?: any): Observable<Array<APIIdentityNamePairResponseDTO>>;
