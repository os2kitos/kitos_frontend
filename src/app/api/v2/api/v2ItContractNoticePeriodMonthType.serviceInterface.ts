...
export interface APIV2ItContractNoticePeriodMonthTypeServiceInterface {
     ...
     */
    gETItContractNoticePeriodMonthTypeV2GetUnboundedPaginationQueryPaginationGuidOrganizationUuid(organizationUuid: string, page?: number, pageSize?: number, extraHttpRequestParams?: any): Observable<Array<APIIdentityNamePairResponseDTO>>;
