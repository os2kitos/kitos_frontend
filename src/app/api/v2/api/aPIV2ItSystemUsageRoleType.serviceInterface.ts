...
export interface APIV2ItSystemUsageRoleTypeServiceInterface {
     ...
     */
    gETItSystemUsageRoleTypeV2GetGuidOrganizationUuidUnboundedPaginationQueryPagination(organizationUuid: string, page?: number, pageSize?: number, extraHttpRequestParams?: any): Observable<Array<RoleOptionResponseDTO>>;
     ...
     */
    gETItSystemUsageRoleTypeV2GetGuidSystemUsageRoleTypeUuidGuidOrganizationUuidBySystemusageroletypeuuid(systemUsageRoleTypeUuid: string, organizationUuid: string, extraHttpRequestParams?: any): Observable<RoleOptionExtendedResponseDTO>;
