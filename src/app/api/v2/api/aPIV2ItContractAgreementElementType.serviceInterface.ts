...
export interface APIV2ItContractAgreementElementTypeServiceInterface {
     ...
     */
    gETItContractAgreementElementTypeV2GetGuidAgreementElementTypeUuidGuidOrganizationUuidByAgreementelementtypeuuid(agreementElementTypeUuid: string, organizationUuid: string, extraHttpRequestParams?: any): Observable<RegularOptionExtendedResponseDTO>;
     ...
     */
    gETItContractAgreementElementTypeV2GetGuidOrganizationUuidUnboundedPaginationQueryPagination(organizationUuid: string, page?: number, pageSize?: number, extraHttpRequestParams?: any): Observable<Array<IdentityNamePairResponseDTO>>;
