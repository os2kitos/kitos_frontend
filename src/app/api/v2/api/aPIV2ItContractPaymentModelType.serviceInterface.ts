...
export interface APIV2ItContractPaymentModelTypeServiceInterface {
     ...
     */
    gETItContractPaymentModelTypeV2GetGuidOrganizationUuidUnboundedPaginationQueryPagination(organizationUuid: string, page?: number, pageSize?: number, extraHttpRequestParams?: any): Observable<Array<IdentityNamePairResponseDTO>>;
     ...
     */
    gETItContractPaymentModelTypeV2GetGuidPaymentModelTypeUuidGuidOrganizationUuidByPaymentmodeltypeuuid(paymentModelTypeUuid: string, organizationUuid: string, extraHttpRequestParams?: any): Observable<RegularOptionExtendedResponseDTO>;
