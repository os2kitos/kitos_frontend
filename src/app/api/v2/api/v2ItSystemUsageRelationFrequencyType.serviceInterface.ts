...
export interface APIV2ItSystemUsageRelationFrequencyTypeServiceInterface {
     ...
     */
    gETItSystemUsageRelationFrequencyTypeV2GetGuidOrganizationUuidGuidRelationFrequencyTypeUuid(relationFrequencyTypeUuid: string, organizationUuid: string, extraHttpRequestParams?: any): Observable<APIRegularOptionExtendedResponseDTO>;
     ...
     */
    gETItSystemUsageRelationFrequencyTypeV2GetUnboundedPaginationQueryPaginationGuidOrganizationUuid(organizationUuid: string, page?: number, pageSize?: number, extraHttpRequestParams?: any): Observable<Array<APIIdentityNamePairResponseDTO>>;
