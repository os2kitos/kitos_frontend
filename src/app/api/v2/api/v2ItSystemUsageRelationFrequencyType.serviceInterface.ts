...
export interface APIV2ItSystemUsageRelationFrequencyTypeServiceInterface {
     ...
     */
    gETItSystemUsageRelationFrequencyTypeV2GetGuidOrganizationUuidUnboundedPaginationQueryPagination(organizationUuid: string, page?: number, pageSize?: number, extraHttpRequestParams?: any): Observable<Array<APIIdentityNamePairResponseDTO>>;
