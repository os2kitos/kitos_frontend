...
export interface APIV2ItContractNoticePeriodMonthTypeServiceInterface {
     ...
     */
    gETItContractNoticePeriodMonthTypeV2GetGuidNoticePeriodMonthTypeUuidGuidOrganizationUuidByNoticeperiodmonthtypeuuid(noticePeriodMonthTypeUuid: string, organizationUuid: string, extraHttpRequestParams?: any): Observable<RegularOptionExtendedResponseDTO>;
     ...
     */
    gETItContractNoticePeriodMonthTypeV2GetGuidOrganizationUuidUnboundedPaginationQueryPagination(organizationUuid: string, page?: number, pageSize?: number, extraHttpRequestParams?: any): Observable<Array<IdentityNamePairResponseDTO>>;
