...
export class APIV2OrganizationService implements APIV2OrganizationServiceInterface {
     ...
     */
    public gETOrganizationV2GetOrganizationGuidOrganizationUuidByOrganizationuuid(organizationUuid: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<Array<OrganizationResponseDTO>>;
    public gETOrganizationV2GetOrganizationGuidOrganizationUuidByOrganizationuuid(organizationUuid: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<Array<OrganizationResponseDTO>>>;
    public gETOrganizationV2GetOrganizationGuidOrganizationUuidByOrganizationuuid(organizationUuid: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<Array<OrganizationResponseDTO>>>;
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public gETOrganizationV2GetOrganizationUnitGuidOrganizationUuidGuidOrganizationUnitIdByOrganizationuuidAndOrganizationunitid(organizationUuid: string, organizationUnitId: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<OrganizationUnitResponseDTO>;
    public gETOrganizationV2GetOrganizationUnitGuidOrganizationUuidGuidOrganizationUnitIdByOrganizationuuidAndOrganizationunitid(organizationUuid: string, organizationUnitId: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<OrganizationUnitResponseDTO>>;
    public gETOrganizationV2GetOrganizationUnitGuidOrganizationUuidGuidOrganizationUnitIdByOrganizationuuidAndOrganizationunitid(organizationUuid: string, organizationUnitId: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<OrganizationUnitResponseDTO>>;
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public gETOrganizationV2GetOrganizationUserGuidOrganizationUuidGuidUserUuidByOrganizationuuidAndUseruuid(organizationUuid: string, userUuid: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<OrganizationUserResponseDTO>;
    public gETOrganizationV2GetOrganizationUserGuidOrganizationUuidGuidUserUuidByOrganizationuuidAndUseruuid(organizationUuid: string, userUuid: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<OrganizationUserResponseDTO>>;
    public gETOrganizationV2GetOrganizationUserGuidOrganizationUuidGuidUserUuidByOrganizationuuidAndUseruuid(organizationUuid: string, userUuid: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<OrganizationUserResponseDTO>>;
