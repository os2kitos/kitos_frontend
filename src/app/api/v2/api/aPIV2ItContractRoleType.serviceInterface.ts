...
export interface APIV2ItContractRoleTypeServiceInterface {
     ...
     */
    gETItContractRoleTypeV2GetGuidContractRoleTypeUuidGuidOrganizationUuidByContractroletypeuuid(contractRoleTypeUuid: string, organizationUuid: string, extraHttpRequestParams?: any): Observable<RoleOptionExtendedResponseDTO>;
     ...
     */
    gETItContractRoleTypeV2GetGuidOrganizationUuidUnboundedPaginationQueryPagination(organizationUuid: string, page?: number, pageSize?: number, extraHttpRequestParams?: any): Observable<Array<RoleOptionResponseDTO>>;
