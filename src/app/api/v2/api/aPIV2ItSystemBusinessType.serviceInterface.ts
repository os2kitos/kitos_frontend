...
export interface APIV2ItSystemBusinessTypeServiceInterface {
     ...
     */
    gETItSystemBusinessTypeV2GetBusinessTypeGuidBusinessTypeUuidGuidOrganizationUuidByBusinesstypeuuid(businessTypeUuid: string, organizationUuid: string, extraHttpRequestParams?: any): Observable<RegularOptionExtendedResponseDTO>;
     ...
     */
    gETItSystemBusinessTypeV2GetBusinessTypesGuidOrganizationUuidUnboundedPaginationQueryPagination(organizationUuid: string, page?: number, pageSize?: number, extraHttpRequestParams?: any): Observable<Array<IdentityNamePairResponseDTO>>;
