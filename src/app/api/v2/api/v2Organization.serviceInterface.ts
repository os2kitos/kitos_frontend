...
import { APIOrganizationResponseDTO } from '../model/models';
import { APIOrganizationUnitResponseDTO } from '../model/models';
import { APIOrganizationUserResponseDTO } from '../model/models';
import { APIShallowOrganizationResponseDTO } from '../model/models';
...
export interface APIV2OrganizationServiceInterface {
     ...
     */
    gETOrganizationV2GetOrganizationUnitGuidOrganizationUnitIdGuidOrganizationUuid(organizationUuid: string, organizationUnitId: string, extraHttpRequestParams?: any): Observable<APIOrganizationUnitResponseDTO>;
     ...
     * @param pageSize Size of the page referred by \&#39;page\&#39;.  Range: [1,100] Default: 100.
     */
    gETOrganizationV2GetOrganizationsAsRightsHolderBoundedPaginationQueryPagination(page?: number, pageSize?: number, extraHttpRequestParams?: any): Observable<Array<APIShallowOrganizationResponseDTO>>;
     ...
     * @param pageSize Size of the page referred by \&#39;page\&#39;.  Range: [1,100] Default: 100.
     */
    gETOrganizationV2GetOrganizationsBoundedPaginationQueryPaginationBooleanOnlyWhereUserHasMembershipStringCvrContentStringNameContent(onlyWhereUserHasMembership?: boolean, nameContent?: string, cvrContent?: string, page?: number, pageSize?: number, extraHttpRequestParams?: any): Observable<Array<APIOrganizationResponseDTO>>;
