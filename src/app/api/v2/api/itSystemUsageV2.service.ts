...
export class ItSystemUsageV2Service {
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleItSystemUsageV2GetIncomingSystemRelations(
    requestParameters: GetSingleItSystemUsageV2GetIncomingSystemRelationsRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
  ...
  public getSingleItSystemUsageV2GetIncomingSystemRelations(
    ...
    if (systemUsageUuid === null || systemUsageUuid === undefined) {
      throw new Error(
        'Required parameter systemUsageUuid was null or undefined when calling getSingleItSystemUsageV2GetIncomingSystemRelations.',
      );
    }
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleItSystemUsageV2GetItSystemUsages(
    requestParameters: GetSingleItSystemUsageV2GetItSystemUsagesRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<any>;
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public postSingleItSystemUsageV2ArchiveItSystemUsage(
    requestParameters: PostSingleItSystemUsageV2ArchiveItSystemUsageRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<any>;
  ...
  public postSingleItSystemUsageV2ArchiveItSystemUsage(
    ...
    if (systemUsageUuid === null || systemUsageUuid === undefined) {
      throw new Error(
        'Required parameter systemUsageUuid was null or undefined when calling postSingleItSystemUsageV2ArchiveItSystemUsage.',
      );
    }
  ...
  public postSingleItSystemUsageV2PostJournalPeriod(
    ...
    if (aPIJournalPeriodDTO === null || aPIJournalPeriodDTO === undefined) {
      throw new Error(
        'Required parameter aPIJournalPeriodDTO was null or undefined when calling postSingleItSystemUsageV2PostJournalPeriod.',
      );
    }
  ...
  public postSingleItSystemUsageV2PostSystemUsageRelation(
    ...
    if (aPISystemRelationWriteRequestDTO === null || aPISystemRelationWriteRequestDTO === undefined) {
      throw new Error(
        'Required parameter aPISystemRelationWriteRequestDTO was null or undefined when calling postSingleItSystemUsageV2PostSystemUsageRelation.',
      );
    }
