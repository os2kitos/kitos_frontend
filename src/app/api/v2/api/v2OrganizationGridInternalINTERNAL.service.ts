...
export interface GetSingleOrganizationGridInternalV2GetGridPermissionsRequestParams {
    organizationUuid: string;
}
...
export class APIV2OrganizationGridInternalINTERNALService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getSingleOrganizationGridInternalV2GetGridPermissions(requestParameters: GetSingleOrganizationGridInternalV2GetGridPermissionsRequestParams, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<object>;
    public getSingleOrganizationGridInternalV2GetGridPermissions(requestParameters: GetSingleOrganizationGridInternalV2GetGridPermissionsRequestParams, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<object>>;
    public getSingleOrganizationGridInternalV2GetGridPermissions(requestParameters: GetSingleOrganizationGridInternalV2GetGridPermissionsRequestParams, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<object>>;
    public getSingleOrganizationGridInternalV2GetGridPermissions(requestParameters: GetSingleOrganizationGridInternalV2GetGridPermissionsRequestParams, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        const organizationUuid = requestParameters.organizationUuid;
        if (organizationUuid === null || organizationUuid === undefined) {
            throw new Error('Required parameter organizationUuid was null or undefined when calling getSingleOrganizationGridInternalV2GetGridPermissions.');
        }
