...
export interface GetSingleOrganizationGridInternalV2GetGridPermissionsByOrganizationuuidRequestParams {
    organizationUuid: string;
}
...
export class APIV2OrganizationGridInternalINTERNALService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getSingleOrganizationGridInternalV2GetGridPermissionsByOrganizationuuid(requestParameters: GetSingleOrganizationGridInternalV2GetGridPermissionsByOrganizationuuidRequestParams, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<APIOrganizationGridPermissionsResponseDTO>;
    ...
    public getSingleOrganizationGridInternalV2GetGridPermissionsByOrganizationuuid(requestParameters: GetSingleOrganizationGridInternalV2GetGridPermissionsByOrganizationuuidRequestParams, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        const organizationUuid = requestParameters.organizationUuid;
        if (organizationUuid === null || organizationUuid === undefined) {
            throw new Error('Required parameter organizationUuid was null or undefined when calling getSingleOrganizationGridInternalV2GetGridPermissionsByOrganizationuuid.');
        }
