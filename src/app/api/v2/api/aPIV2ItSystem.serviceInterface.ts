...
import { ItSystemResponseDTO } from '../model/models';
import { RightsHolderCreateItSystemRequestDTO } from '../model/models';
import { RightsHolderItSystemResponseDTO } from '../model/models';
import { RightsHolderPartialUpdateSystemPropertiesRequestDTO } from '../model/models';
import { RightsHolderWritableITSystemPropertiesDTO } from '../model/models';
...
export interface APIV2ItSystemServiceInterface {
     ...
     */
    dELETEItSystemV2DeactivateSystemAsRightsHolderGuidUuidDeactivationReasonRequestDTORequestByUuid(uuid: string, request: DeactivationReasonRequestDTO, extraHttpRequestParams?: any): Observable<object>;
     ...
     * @param uuid Specific IT-System UUID
     */
    gETItSystemV2GetItSystemByRightsHoldersAccessGuidUuid(uuid: string, extraHttpRequestParams?: any): Observable<RightsHolderItSystemResponseDTO>;
     ...
     * @param uuid Specific IT-System UUID
     */
    gETItSystemV2GetItSystemGuidUuidByUuid(uuid: string, extraHttpRequestParams?: any): Observable<ItSystemResponseDTO>;
     ...
     * @param request 
     */
    pATCHItSystemV2PatchItSystemAsRightsHolderGuidUuidRightsHolderPartialUpdateSystemPropertiesRequestDTORequestByUuid(uuid: string, request: RightsHolderPartialUpdateSystemPropertiesRequestDTO, extraHttpRequestParams?: any): Observable<RightsHolderItSystemResponseDTO>;
     ...
     */
    pOSTItSystemV2PostItSystemAsRightsHolderRightsHolderCreateItSystemRequestDTORequest(request: RightsHolderCreateItSystemRequestDTO, extraHttpRequestParams?: any): Observable<RightsHolderItSystemResponseDTO>;
     ...
     * @param request 
     */
    pUTItSystemV2PutItSystemAsRightsHolderGuidUuidRightsHolderWritableITSystemPropertiesDTORequestByUuid(uuid: string, request: RightsHolderWritableITSystemPropertiesDTO, extraHttpRequestParams?: any): Observable<RightsHolderItSystemResponseDTO>;
