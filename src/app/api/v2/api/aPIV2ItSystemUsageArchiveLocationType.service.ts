...
export class APIV2ItSystemUsageArchiveLocationTypeService implements APIV2ItSystemUsageArchiveLocationTypeServiceInterface {
     ...
     */
    public gETItSystemUsageArchiveLocationTypeV2GetGuidArchiveLocationUuidGuidOrganizationUuidByArchivelocationuuid(archiveLocationUuid: string, organizationUuid: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<RegularOptionExtendedResponseDTO>;
    public gETItSystemUsageArchiveLocationTypeV2GetGuidArchiveLocationUuidGuidOrganizationUuidByArchivelocationuuid(archiveLocationUuid: string, organizationUuid: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<RegularOptionExtendedResponseDTO>>;
    public gETItSystemUsageArchiveLocationTypeV2GetGuidArchiveLocationUuidGuidOrganizationUuidByArchivelocationuuid(archiveLocationUuid: string, organizationUuid: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<RegularOptionExtendedResponseDTO>>;
