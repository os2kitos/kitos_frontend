...
export interface APIV2ItContractPaymentFrequencyTypeServiceInterface {
     ...
     */
    gETItContractPaymentFrequencyTypeV2GetGuidOrganizationUuidUnboundedPaginationQueryPagination(organizationUuid: string, page?: number, pageSize?: number, extraHttpRequestParams?: any): Observable<Array<IdentityNamePairResponseDTO>>;
     ...
     */
    gETItContractPaymentFrequencyTypeV2GetGuidPaymentFrequencyTypeUuidGuidOrganizationUuidByPaymentfrequencytypeuuid(paymentFrequencyTypeUuid: string, organizationUuid: string, extraHttpRequestParams?: any): Observable<RegularOptionExtendedResponseDTO>;
