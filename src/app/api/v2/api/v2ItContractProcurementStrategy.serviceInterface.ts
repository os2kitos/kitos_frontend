...
export interface APIV2ItContractProcurementStrategyServiceInterface {
     ...
     */
    gETItContractProcurementStrategyV2GetGuidOrganizationUuidGuidProcurementStrategyTypeUuid(procurementStrategyTypeUuid: string, organizationUuid: string, extraHttpRequestParams?: any): Observable<APIRegularOptionExtendedResponseDTO>;
     ...
     */
    gETItContractProcurementStrategyV2GetUnboundedPaginationQueryPaginationGuidOrganizationUuid(organizationUuid: string, page?: number, pageSize?: number, extraHttpRequestParams?: any): Observable<Array<APIIdentityNamePairResponseDTO>>;
