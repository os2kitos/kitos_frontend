...
export class APIV2ItContractPaymentModelTypeService {
    ...
    public gETItContractPaymentModelTypeV2GetGuidOrganizationUuidGuidPaymentModelTypeUuidByPaymentmodeltypeuuid(paymentModelTypeUuid: string, organizationUuid: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        if (paymentModelTypeUuid === null || paymentModelTypeUuid === undefined) {
            throw new Error('Required parameter paymentModelTypeUuid was null or undefined when calling gETItContractPaymentModelTypeV2GetGuidOrganizationUuidGuidPaymentModelTypeUuidByPaymentmodeltypeuuid.');
        }
        if (organizationUuid === null || organizationUuid === undefined) {
            throw new Error('Required parameter organizationUuid was null or undefined when calling gETItContractPaymentModelTypeV2GetGuidOrganizationUuidGuidPaymentModelTypeUuidByPaymentmodeltypeuuid.');
        }
