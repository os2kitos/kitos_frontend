...
export class APIV2ItContractCriticalityTypeService implements APIV2ItContractCriticalityTypeServiceInterface {
     ...
     */
    public gETItContractCriticalityTypeV2GetGuidCriticalityTypeUuidGuidOrganizationUuidByCriticalitytypeuuid(criticalityTypeUuid: string, organizationUuid: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<APIRegularOptionExtendedResponseDTO>;
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public gETItContractCriticalityTypeV2GetGuidOrganizationUuidUnboundedPaginationQueryPagination(organizationUuid: string, page?: number, pageSize?: number, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<Array<APIIdentityNamePairResponseDTO>>;
