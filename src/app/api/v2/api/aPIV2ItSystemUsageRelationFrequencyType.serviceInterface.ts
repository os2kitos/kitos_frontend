...
export interface APIV2ItSystemUsageRelationFrequencyTypeServiceInterface {
     ...
     */
    gETItSystemUsageRelationFrequencyTypeV2GetGuidOrganizationUuidUnboundedPaginationQueryPagination(organizationUuid: string, page?: number, pageSize?: number, extraHttpRequestParams?: any): Observable<Array<IdentityNamePairResponseDTO>>;
     ...
     * @param organizationUuid organization context for the relation frequency type availability
     */
    gETItSystemUsageRelationFrequencyTypeV2GetGuidRelationFrequencyTypeUuidGuidOrganizationUuidByRelationfrequencytypeuuid(relationFrequencyTypeUuid: string, organizationUuid: string, extraHttpRequestParams?: any): Observable<RegularOptionExtendedResponseDTO>;
