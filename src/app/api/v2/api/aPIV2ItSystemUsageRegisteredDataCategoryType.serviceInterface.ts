...
export interface APIV2ItSystemUsageRegisteredDataCategoryTypeServiceInterface {
     ...
     */
    gETItSystemUsageRegisteredDataCategoryTypeV2GetGuidOrganizationUuidUnboundedPaginationQueryPagination(organizationUuid: string, page?: number, pageSize?: number, extraHttpRequestParams?: any): Observable<Array<IdentityNamePairResponseDTO>>;
     ...
     * @param organizationUuid organization context for the type availability
     */
    gETItSystemUsageRegisteredDataCategoryTypeV2GetGuidRegisteredDataCatagoryTypeUuidGuidOrganizationUuidByRegistereddatacatagorytypeuuid(registeredDataCatagoryTypeUuid: string, organizationUuid: string, extraHttpRequestParams?: any): Observable<RegularOptionExtendedResponseDTO>;
