...
export interface APIV2ItSystemUsageArchiveLocationTypeServiceInterface {
     ...
     */
    gETItSystemUsageArchiveLocationTypeV2GetGuidArchiveLocationUuidGuidOrganizationUuidByArchivelocationuuid(archiveLocationUuid: string, organizationUuid: string, extraHttpRequestParams?: any): Observable<RegularOptionExtendedResponseDTO>;
     ...
     */
    gETItSystemUsageArchiveLocationTypeV2GetGuidOrganizationUuidUnboundedPaginationQueryPagination(organizationUuid: string, page?: number, pageSize?: number, extraHttpRequestParams?: any): Observable<Array<IdentityNamePairResponseDTO>>;
