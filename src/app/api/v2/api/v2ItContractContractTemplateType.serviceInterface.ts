...
export interface APIV2ItContractContractTemplateTypeServiceInterface {
     ...
     */
    gETItContractContractTemplateTypeV2GetGuidOrganizationUuidUnboundedPaginationQueryPagination(organizationUuid: string, page?: number, pageSize?: number, extraHttpRequestParams?: any): Observable<Array<APIIdentityNamePairResponseDTO>>;
