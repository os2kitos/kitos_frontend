...
export interface APIV2ItContractContractTypeServiceInterface {
     ...
     */
    gETItContractContractTypeV2GetGuidContractTypeUuidGuidOrganizationUuidByContracttypeuuid(contractTypeUuid: string, organizationUuid: string, extraHttpRequestParams?: any): Observable<RegularOptionExtendedResponseDTO>;
     ...
     */
    gETItContractContractTypeV2GetGuidOrganizationUuidUnboundedPaginationQueryPagination(organizationUuid: string, page?: number, pageSize?: number, extraHttpRequestParams?: any): Observable<Array<IdentityNamePairResponseDTO>>;
