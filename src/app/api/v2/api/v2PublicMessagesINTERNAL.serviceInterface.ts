...
import { APIPublicMessagesResponseDTO } from '../model/models';
...
export interface APIV2PublicMessagesINTERNALServiceInterface {
     ...
     * 
     */
    gETPublicMessagesV2Get(extraHttpRequestParams?: any): Observable<APIPublicMessagesResponseDTO>;
