...
export interface APIV2DataProcessingRegistrationCountryTypeServiceInterface {
     ...
     */
    gETDataProcessingRegistrationCountryTypeV2GetGuidCountryUuidGuidOrganizationUuidByCountryuuid(countryUuid: string, organizationUuid: string, extraHttpRequestParams?: any): Observable<RegularOptionExtendedResponseDTO>;
     ...
     */
    gETDataProcessingRegistrationCountryTypeV2GetGuidOrganizationUuidUnboundedPaginationQueryPagination(organizationUuid: string, page?: number, pageSize?: number, extraHttpRequestParams?: any): Observable<Array<IdentityNamePairResponseDTO>>;
