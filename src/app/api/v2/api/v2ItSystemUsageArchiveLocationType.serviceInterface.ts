...
export interface APIV2ItSystemUsageArchiveLocationTypeServiceInterface {
     ...
     */
    gETItSystemUsageArchiveLocationTypeV2GetUnboundedPaginationQueryPaginationGuidOrganizationUuid(organizationUuid: string, page?: number, pageSize?: number, extraHttpRequestParams?: any): Observable<Array<APIIdentityNamePairResponseDTO>>;
