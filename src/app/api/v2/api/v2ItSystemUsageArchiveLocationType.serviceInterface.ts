...
export interface APIV2ItSystemUsageArchiveLocationTypeServiceInterface {
     ...
     */
    gETItSystemUsageArchiveLocationTypeV2GetGuidOrganizationUuidUnboundedPaginationQueryPagination(organizationUuid: string, page?: number, pageSize?: number, extraHttpRequestParams?: any): Observable<Array<APIIdentityNamePairResponseDTO>>;
