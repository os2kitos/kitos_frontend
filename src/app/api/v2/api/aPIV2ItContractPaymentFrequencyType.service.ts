...
export class APIV2ItContractPaymentFrequencyTypeService implements APIV2ItContractPaymentFrequencyTypeServiceInterface {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public gETItContractPaymentFrequencyTypeV2GetGuidPaymentFrequencyTypeUuidGuidOrganizationUuidByPaymentfrequencytypeuuid(paymentFrequencyTypeUuid: string, organizationUuid: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<RegularOptionExtendedResponseDTO>;
    public gETItContractPaymentFrequencyTypeV2GetGuidPaymentFrequencyTypeUuidGuidOrganizationUuidByPaymentfrequencytypeuuid(paymentFrequencyTypeUuid: string, organizationUuid: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<RegularOptionExtendedResponseDTO>>;
    public gETItContractPaymentFrequencyTypeV2GetGuidPaymentFrequencyTypeUuidGuidOrganizationUuidByPaymentfrequencytypeuuid(paymentFrequencyTypeUuid: string, organizationUuid: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<RegularOptionExtendedResponseDTO>>;
