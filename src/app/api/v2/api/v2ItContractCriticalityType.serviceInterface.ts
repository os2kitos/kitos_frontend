...
export interface APIV2ItContractCriticalityTypeServiceInterface {
     ...
     */
    gETItContractCriticalityTypeV2GetGuidOrganizationUuidUnboundedPaginationQueryPagination(organizationUuid: string, page?: number, pageSize?: number, extraHttpRequestParams?: any): Observable<Array<APIIdentityNamePairResponseDTO>>;
