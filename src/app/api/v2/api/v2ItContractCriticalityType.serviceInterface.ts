...
export interface APIV2ItContractCriticalityTypeServiceInterface {
     ...
     */
    gETItContractCriticalityTypeV2GetUnboundedPaginationQueryPaginationGuidOrganizationUuid(organizationUuid: string, page?: number, pageSize?: number, extraHttpRequestParams?: any): Observable<Array<APIIdentityNamePairResponseDTO>>;
