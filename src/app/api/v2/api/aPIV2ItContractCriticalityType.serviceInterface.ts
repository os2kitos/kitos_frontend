...
export interface APIV2ItContractCriticalityTypeServiceInterface {
     ...
     */
    gETItContractCriticalityTypeV2GetGuidCriticalityTypeUuidGuidOrganizationUuidByCriticalitytypeuuid(criticalityTypeUuid: string, organizationUuid: string, extraHttpRequestParams?: any): Observable<RegularOptionExtendedResponseDTO>;
     ...
     */
    gETItContractCriticalityTypeV2GetGuidOrganizationUuidUnboundedPaginationQueryPagination(organizationUuid: string, page?: number, pageSize?: number, extraHttpRequestParams?: any): Observable<Array<IdentityNamePairResponseDTO>>;
