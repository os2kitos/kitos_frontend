...
export interface APIV2ItContractPurchaseTypeServiceInterface {
     ...
     */
    gETItContractPurchaseTypeV2GetGuidOrganizationUuidUnboundedPaginationQueryPagination(organizationUuid: string, page?: number, pageSize?: number, extraHttpRequestParams?: any): Observable<Array<IdentityNamePairResponseDTO>>;
     ...
     */
    gETItContractPurchaseTypeV2GetGuidPurchaseTypeUuidGuidOrganizationUuidByPurchasetypeuuid(purchaseTypeUuid: string, organizationUuid: string, extraHttpRequestParams?: any): Observable<RegularOptionExtendedResponseDTO>;
