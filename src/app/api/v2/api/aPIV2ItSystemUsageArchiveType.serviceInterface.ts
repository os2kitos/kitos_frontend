...
export interface APIV2ItSystemUsageArchiveTypeServiceInterface {
     ...
     */
    gETItSystemUsageArchiveTypeV2GetGuidArchiveTypeUuidGuidOrganizationUuidByArchivetypeuuid(archiveTypeUuid: string, organizationUuid: string, extraHttpRequestParams?: any): Observable<RegularOptionExtendedResponseDTO>;
     ...
     */
    gETItSystemUsageArchiveTypeV2GetGuidOrganizationUuidUnboundedPaginationQueryPagination(organizationUuid: string, page?: number, pageSize?: number, extraHttpRequestParams?: any): Observable<Array<IdentityNamePairResponseDTO>>;
