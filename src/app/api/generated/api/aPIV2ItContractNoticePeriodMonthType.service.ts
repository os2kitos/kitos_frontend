...
} from './aPIV2ItContractNoticePeriodMonthType.serviceInterface';
...
export class APIV2ItContractNoticePeriodMonthTypeService implements APIV2ItContractNoticePeriodMonthTypeServiceInterface {
     ...
     */
    public gETItContractNoticePeriodMonthTypeV2GetGuidNoticePeriodMonthTypeUuidGuidOrganizationUuid(noticePeriodMonthTypeUuid: string, organizationUuid: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<RegularOptionExtendedResponseDTO>;
    public gETItContractNoticePeriodMonthTypeV2GetGuidNoticePeriodMonthTypeUuidGuidOrganizationUuid(noticePeriodMonthTypeUuid: string, organizationUuid: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<RegularOptionExtendedResponseDTO>>;
    public gETItContractNoticePeriodMonthTypeV2GetGuidNoticePeriodMonthTypeUuidGuidOrganizationUuid(noticePeriodMonthTypeUuid: string, organizationUuid: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<RegularOptionExtendedResponseDTO>>;
     ...
     * @param organizationUuid organization context for the notice period month types availability
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public gETItContractNoticePeriodMonthTypeV2GetGuidOrganizationUuidUnboundedPaginationQueryPagination(organizationUuid: string, page?: number, pageSize?: number, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<Array<IdentityNamePairResponseDTO>>;
