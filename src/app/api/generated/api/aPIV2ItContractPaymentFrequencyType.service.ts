...
import {
    APIV2ItContractPaymentFrequencyTypeServiceInterface
} from './aPIV2ItContractPaymentFrequencyType.serviceInterface';
...
export class APIV2ItContractPaymentFrequencyTypeService implements APIV2ItContractPaymentFrequencyTypeServiceInterface {
     ...
     */
    public gETItContractPaymentFrequencyTypeV2GetGuidOrganizationUuidUnboundedPaginationQueryPagination(organizationUuid: string, page?: number, pageSize?: number, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<Array<IdentityNamePairResponseDTO>>;
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public gETItContractPaymentFrequencyTypeV2GetGuidPaymentFrequencyTypeUuidGuidOrganizationUuid(paymentFrequencyTypeUuid: string, organizationUuid: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<RegularOptionExtendedResponseDTO>;
    public gETItContractPaymentFrequencyTypeV2GetGuidPaymentFrequencyTypeUuidGuidOrganizationUuid(paymentFrequencyTypeUuid: string, organizationUuid: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<RegularOptionExtendedResponseDTO>>;
    public gETItContractPaymentFrequencyTypeV2GetGuidPaymentFrequencyTypeUuidGuidOrganizationUuid(paymentFrequencyTypeUuid: string, organizationUuid: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<RegularOptionExtendedResponseDTO>>;
