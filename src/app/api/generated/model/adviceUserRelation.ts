...
export namespace AdviceUserRelation {
    ...
    export const RecieverTypeEnum = {
        ...
        Reciever: 'RECIEVER' as RecieverTypeEnum
    };
    export type RecpientTypeEnum = 'ROLE' | 'USER';
    export const RecpientTypeEnum = {
        Role: 'ROLE' as RecpientTypeEnum,
        User: 'USER' as RecpientTypeEnum
    };
}
