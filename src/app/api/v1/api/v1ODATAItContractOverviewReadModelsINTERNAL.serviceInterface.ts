...
export interface APIV1ODATAItContractOverviewReadModelsINTERNALServiceInterface {
     ...
     */
    gETItContractOverviewReadModelsGetInt32OrganizationIdNullable1ResponsibleOrganizationUnitIdByOrganizationid(organizationId: number, responsibleOrganizationUnitId?: number, $expand?: string, $select?: string, extraHttpRequestParams?: any): Observable<object>;
