...
import { ItInterfaceDTOIEnumerableApiReturnDTO } from '../model/models';
...
export interface APIV1ExhibitServiceInterface {
     ...
     * @param interfaces 
     */
    gETExhibitGetInterfacesBySystemInt32SysIdInt32OrgIdNullable1Interfaces(sysId: number, orgId: number, interfaces: boolean, extraHttpRequestParams?: any): Observable<ItInterfaceDTOIEnumerableApiReturnDTO>;
