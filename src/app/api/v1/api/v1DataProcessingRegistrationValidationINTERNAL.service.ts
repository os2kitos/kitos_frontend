...
import {
    APIV1DataProcessingRegistrationValidationINTERNALServiceInterface
} from './v1DataProcessingRegistrationValidationINTERNAL.serviceInterface';
...
export class APIV1DataProcessingRegistrationValidationINTERNALService implements APIV1DataProcessingRegistrationValidationINTERNALServiceInterface {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public gETDataProcessingRegistrationValidationGetAccessRightsInt32OrganizationIdNullable1GetEntitiesAccessRights(getEntitiesAccessRights: boolean, organizationId: number, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'text/json', context?: HttpContext}): Observable<object>;
    public gETDataProcessingRegistrationValidationGetAccessRightsInt32OrganizationIdNullable1GetEntitiesAccessRights(getEntitiesAccessRights: boolean, organizationId: number, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'text/json', context?: HttpContext}): Observable<HttpResponse<object>>;
    ...
    public gETDataProcessingRegistrationValidationGetAccessRightsInt32OrganizationIdNullable1GetEntitiesAccessRights(getEntitiesAccessRights: boolean, organizationId: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json' | 'text/json', context?: HttpContext}): Observable<any> {
        if (getEntitiesAccessRights === null || getEntitiesAccessRights === undefined) {
            throw new Error('Required parameter getEntitiesAccessRights was null or undefined when calling gETDataProcessingRegistrationValidationGetAccessRightsInt32OrganizationIdNullable1GetEntitiesAccessRights.');
        }
        if (organizationId === null || organizationId === undefined) {
            throw new Error('Required parameter organizationId was null or undefined when calling gETDataProcessingRegistrationValidationGetAccessRightsInt32OrganizationIdNullable1GetEntitiesAccessRights.');
        }
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public pOSTDataProcessingRegistrationValidationPostSearchAccessRightsForEntityListInt32IdsNullable1GetEntityListAccessRights(getEntityListAccessRights: boolean, ids: Array<number>, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'text/json', context?: HttpContext}): Observable<object>;
    ...
    public pOSTDataProcessingRegistrationValidationPostSearchAccessRightsForEntityListInt32IdsNullable1GetEntityListAccessRights(getEntityListAccessRights: boolean, ids: Array<number>, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json' | 'text/json', context?: HttpContext}): Observable<any> {
        if (getEntityListAccessRights === null || getEntityListAccessRights === undefined) {
            throw new Error('Required parameter getEntityListAccessRights was null or undefined when calling pOSTDataProcessingRegistrationValidationPostSearchAccessRightsForEntityListInt32IdsNullable1GetEntityListAccessRights.');
        }
        if (ids === null || ids === undefined) {
            throw new Error('Required parameter ids was null or undefined when calling pOSTDataProcessingRegistrationValidationPostSearchAccessRightsForEntityListInt32IdsNullable1GetEntityListAccessRights.');
        }
