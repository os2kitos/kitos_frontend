...
export class APIV1OrganizationUnitINTERNALService implements APIV1OrganizationUnitINTERNALServiceInterface {
     ...
     */
    public gETOrganizationUnitGetByUserNullable1ByUserInt32OrganizationId(byUser: boolean, organizationId: number, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'text/json', context?: HttpContext}): Observable<object>;
    public gETOrganizationUnitGetByUserNullable1ByUserInt32OrganizationId(byUser: boolean, organizationId: number, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'text/json', context?: HttpContext}): Observable<HttpResponse<object>>;
    public gETOrganizationUnitGetByUserNullable1ByUserInt32OrganizationId(byUser: boolean, organizationId: number, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'text/json', context?: HttpContext}): Observable<HttpEvent<object>>;
    public gETOrganizationUnitGetByUserNullable1ByUserInt32OrganizationId(byUser: boolean, organizationId: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json' | 'text/json', context?: HttpContext}): Observable<any> {
        if (byUser === null || byUser === undefined) {
            throw new Error('Required parameter byUser was null or undefined when calling gETOrganizationUnitGetByUserNullable1ByUserInt32OrganizationId.');
        }
        if (organizationId === null || organizationId === undefined) {
            throw new Error('Required parameter organizationId was null or undefined when calling gETOrganizationUnitGetByUserNullable1ByUserInt32OrganizationId.');
        }
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public gETOrganizationUnitGetChildrenInt32IdNullable1ChildrenPagingModel1PagingById(id: number, children: boolean, take?: number, skip?: number, orderBy?: string, descending?: boolean, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'text/json', context?: HttpContext}): Observable<object>;
    public gETOrganizationUnitGetChildrenInt32IdNullable1ChildrenPagingModel1PagingById(id: number, children: boolean, take?: number, skip?: number, orderBy?: string, descending?: boolean, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'text/json', context?: HttpContext}): Observable<HttpResponse<object>>;
    ...
    public gETOrganizationUnitGetChildrenInt32IdNullable1ChildrenPagingModel1PagingById(id: number, children: boolean, take?: number, skip?: number, orderBy?: string, descending?: boolean, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json' | 'text/json', context?: HttpContext}): Observable<any> {
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling gETOrganizationUnitGetChildrenInt32IdNullable1ChildrenPagingModel1PagingById.');
        }
        if (children === null || children === undefined) {
            throw new Error('Required parameter children was null or undefined when calling gETOrganizationUnitGetChildrenInt32IdNullable1ChildrenPagingModel1PagingById.');
        }
