...
export interface APIV1ODATAOrganizationUnitRightsINTERNALServiceInterface {
     ...
     */
    gETOrganizationUnitRightsGet($expand?: string, $filter?: string, $select?: string, $orderby?: string, $top?: number, $skip?: number, $count?: boolean, extraHttpRequestParams?: any): Observable<object>;
     ...
     * @param $select Selects which properties to include in the response.
     */
    gETOrganizationUnitRightsGetByUserInt32UserId(userId: number, $expand?: string, $select?: string, extraHttpRequestParams?: any): Observable<object>;
