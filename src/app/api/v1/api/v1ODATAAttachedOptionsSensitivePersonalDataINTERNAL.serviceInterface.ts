...
export interface APIV1ODATAAttachedOptionsSensitivePersonalDataINTERNALServiceInterface {
     ...
     */
    gETAttachedOptionsSensitivePersonalDataGetSensitivePersonalDataByUsageIdInt32Id(id: number, $expand?: string, $select?: string, extraHttpRequestParams?: any): Observable<object>;
