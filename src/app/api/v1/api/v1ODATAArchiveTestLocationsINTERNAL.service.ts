...
// @ts-ignore
import { APIArchiveTestLocation } from '../model/aPIArchiveTestLocation';

// @ts-ignore
import { BASE_PATH, COLLECTION_FORMATS }                     from '../variables';
import { Configuration }                                     from '../configuration';
import {
    APIV1ODATAArchiveTestLocationsINTERNALServiceInterface
} from './v1ODATAArchiveTestLocationsINTERNAL.serviceInterface';
...
export class APIV1ODATAArchiveTestLocationsINTERNALService implements APIV1ODATAArchiveTestLocationsINTERNALServiceInterface {
    ...
    /**
     * Update entity in EntitySet ArchiveTestLocations
     * @param id key: Id
     * @param archiveTestLocation The entity to patch
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public pATCHArchiveTestLocationsPatchDelta1DeltaInt32KeyById(id: number, archiveTestLocation: APIArchiveTestLocation, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<object>;
    public pATCHArchiveTestLocationsPatchDelta1DeltaInt32KeyById(id: number, archiveTestLocation: APIArchiveTestLocation, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<object>>;
    public pATCHArchiveTestLocationsPatchDelta1DeltaInt32KeyById(id: number, archiveTestLocation: APIArchiveTestLocation, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<object>>;
    public pATCHArchiveTestLocationsPatchDelta1DeltaInt32KeyById(id: number, archiveTestLocation: APIArchiveTestLocation, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling pATCHArchiveTestLocationsPatchDelta1DeltaInt32KeyById.');
        }
        if (archiveTestLocation === null || archiveTestLocation === undefined) {
            throw new Error('Required parameter archiveTestLocation was null or undefined when calling pATCHArchiveTestLocationsPatchDelta1DeltaInt32KeyById.');
        }
