...
import { APILocalPaymentModelType } from '../model/models';
...
export interface APIV1ODATALocalPaymentModelTypesINTERNALServiceInterface {
     ...
     * @param key 
     */
    dELETELocalPaymentModelTypesDeleteInt32KeyInt32OrganizationId(organizationId: number, key: number, extraHttpRequestParams?: any): Observable<object>;
     ...
     */
    gETLocalPaymentModelTypesGetByOrganizationIdInt32OrganizationId(organizationId: number, $expand?: string, $select?: string, extraHttpRequestParams?: any): Observable<object>;
     ...
     * @param delta 
     */
    pATCHLocalPaymentModelTypesPatchDelta1DeltaInt32KeyInt32OrganizationId(organizationId: number, key: number, delta: APILocalPaymentModelType, extraHttpRequestParams?: any): Observable<object>;
     ...
     * @param entity 
     */
    pOSTLocalPaymentModelTypesPostLocalPaymentModelTypeEntityInt32OrganizationId(organizationId: number, entity: APILocalPaymentModelType, extraHttpRequestParams?: any): Observable<object>;
