...
// @ts-ignore
import { DataResponsibleDTOApiReturnDTO } from '../model/dataResponsibleDTOApiReturnDTO';
...
} from './aPIV1DataResponsible.serviceInterface';
...
export class APIV1DataResponsibleService implements APIV1DataResponsibleServiceInterface {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public gETDataResponsibleGetSingleInt32Id(id: number, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'text/json', context?: HttpContext}): Observable<DataResponsibleDTOApiReturnDTO>;
    public gETDataResponsibleGetSingleInt32Id(id: number, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'text/json', context?: HttpContext}): Observable<HttpResponse<DataResponsibleDTOApiReturnDTO>>;
    public gETDataResponsibleGetSingleInt32Id(id: number, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'text/json', context?: HttpContext}): Observable<HttpEvent<DataResponsibleDTOApiReturnDTO>>;
    public gETDataResponsibleGetSingleInt32Id(id: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json' | 'text/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.request<DataResponsibleDTOApiReturnDTO>('get', `${this.configuration.basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
