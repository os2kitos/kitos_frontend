...
export interface APIV1ODATAItSystemRightsServiceInterface {
     ...
     * @param $count Includes a count of the matching results in the response.
     */
    gETItSystemRightsGetByUserInt32UserId(userId: number, $expand?: string, $filter?: string, $select?: string, $orderby?: string, $top?: number, $skip?: number, $count?: boolean, extraHttpRequestParams?: any): Observable<APIItSystemRightIQueryableODataResponse>;
