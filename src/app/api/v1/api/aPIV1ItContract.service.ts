...
// @ts-ignore
import { ItContractDTOApiReturnDTO } from '../model/itContractDTOApiReturnDTO';
// @ts-ignore
import { NamedEntityDTOIEnumerableApiReturnDTO } from '../model/namedEntityDTOIEnumerableApiReturnDTO';
...
} from './aPIV1ItContract.serviceInterface';
...
export class APIV1ItContractService implements APIV1ItContractServiceInterface {
     ...
     */
    public gETItContractGetAvailableDataProcessingRegistrationsInt32IdStringNameQueryInt32PageSize(id: number, nameQuery?: string, pageSize?: number, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext}): Observable<any>;
    public gETItContractGetAvailableDataProcessingRegistrationsInt32IdStringNameQueryInt32PageSize(id: number, nameQuery?: string, pageSize?: number, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext}): Observable<HttpResponse<any>>;
    public gETItContractGetAvailableDataProcessingRegistrationsInt32IdStringNameQueryInt32PageSize(id: number, nameQuery?: string, pageSize?: number, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext}): Observable<HttpEvent<any>>;
    public gETItContractGetAvailableDataProcessingRegistrationsInt32IdStringNameQueryInt32PageSize(id: number, nameQuery?: string, pageSize?: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: undefined, context?: HttpContext}): Observable<any> {
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling gETItContractGetAvailableDataProcessingRegistrationsInt32IdStringNameQueryInt32PageSize.');
        }
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public gETItContractGetSingleInt32Id(id: number, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'text/json', context?: HttpContext}): Observable<ItContractDTOApiReturnDTO>;
    public gETItContractGetSingleInt32Id(id: number, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'text/json', context?: HttpContext}): Observable<HttpResponse<ItContractDTOApiReturnDTO>>;
    public gETItContractGetSingleInt32Id(id: number, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'text/json', context?: HttpContext}): Observable<HttpEvent<ItContractDTOApiReturnDTO>>;
    public gETItContractGetSingleInt32Id(id: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json' | 'text/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.request<ItContractDTOApiReturnDTO>('get', `${this.configuration.basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public gETItContractGetStringQInt32OrgIdPagingModel1Paging(q: string, orgId: number, take?: number, skip?: number, orderBy?: string, descending?: boolean, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'text/json', context?: HttpContext}): Observable<NamedEntityDTOIEnumerableApiReturnDTO>;
    public gETItContractGetStringQInt32OrgIdPagingModel1Paging(q: string, orgId: number, take?: number, skip?: number, orderBy?: string, descending?: boolean, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'text/json', context?: HttpContext}): Observable<HttpResponse<NamedEntityDTOIEnumerableApiReturnDTO>>;
    public gETItContractGetStringQInt32OrgIdPagingModel1Paging(q: string, orgId: number, take?: number, skip?: number, orderBy?: string, descending?: boolean, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'text/json', context?: HttpContext}): Observable<HttpEvent<NamedEntityDTOIEnumerableApiReturnDTO>>;
    public gETItContractGetStringQInt32OrgIdPagingModel1Paging(q: string, orgId: number, take?: number, skip?: number, orderBy?: string, descending?: boolean, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json' | 'text/json', context?: HttpContext}): Observable<any> {
        if (q === null || q === undefined) {
            throw new Error('Required parameter q was null or undefined when calling gETItContractGetStringQInt32OrgIdPagingModel1Paging.');
        }
        if (orgId === null || orgId === undefined) {
            throw new Error('Required parameter orgId was null or undefined when calling gETItContractGetStringQInt32OrgIdPagingModel1Paging.');
        }
        ...
        return this.httpClient.request<NamedEntityDTOIEnumerableApiReturnDTO>('get', `${this.configuration.basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
                params: localVarQueryParameters,
                responseType: <any>responseType_,
