...
import { ItSystemDTOIEnumerableApiReturnDTO } from '../model/models';
import { NamedEntityWithEnabledStatusDTOIEnumerableApiReturnDTO } from '../model/models';
import { UsingOrganizationDTOIEnumerableApiReturnDTO } from '../model/models';
...
export interface APIV1ItSystemServiceInterface {
     ...
     * @param hierarchy 
     */
    gETItSystemGetHierarchyInt32IdBooleanHierarchy(id: number, hierarchy: boolean, extraHttpRequestParams?: any): Observable<ItSystemDTOIEnumerableApiReturnDTO>;
     ...
     */
    gETItSystemGetPublicInt32OrganizationIdPagingModel1PagingStringQ(organizationId: number, q: string, take?: number, skip?: number, orderBy?: string, descending?: boolean, extraHttpRequestParams?: any): Observable<NamedEntityWithEnabledStatusDTOIEnumerableApiReturnDTO>;
     ...
     * @param id 
     */
    gETItSystemGetUsingOrganizationsInt32Id(id: number, extraHttpRequestParams?: any): Observable<UsingOrganizationDTOIEnumerableApiReturnDTO>;
