...
// @ts-ignore
import { DataProtectionAdvisorDTOApiReturnDTO } from '../model/dataProtectionAdvisorDTOApiReturnDTO';
...
} from './aPIV1DataProtectionAdvisor.serviceInterface';
...
export class APIV1DataProtectionAdvisorService implements APIV1DataProtectionAdvisorServiceInterface {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public gETDataProtectionAdvisorGetSingleInt32Id(id: number, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'text/json', context?: HttpContext}): Observable<DataProtectionAdvisorDTOApiReturnDTO>;
    public gETDataProtectionAdvisorGetSingleInt32Id(id: number, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'text/json', context?: HttpContext}): Observable<HttpResponse<DataProtectionAdvisorDTOApiReturnDTO>>;
    public gETDataProtectionAdvisorGetSingleInt32Id(id: number, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'text/json', context?: HttpContext}): Observable<HttpEvent<DataProtectionAdvisorDTOApiReturnDTO>>;
    public gETDataProtectionAdvisorGetSingleInt32Id(id: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json' | 'text/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.request<DataProtectionAdvisorDTOApiReturnDTO>('get', `${this.configuration.basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
