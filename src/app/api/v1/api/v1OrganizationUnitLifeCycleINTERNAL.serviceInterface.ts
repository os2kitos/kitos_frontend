...
export interface APIV1OrganizationUnitLifeCycleINTERNALServiceInterface {
     ...
     */
    gETOrganizationUnitLifeCycleGetAccessRightsForEntityInt32IdNullable1GetEntityAccessRightsById(id: number, getEntityAccessRights: boolean, extraHttpRequestParams?: any): Observable<object>;
