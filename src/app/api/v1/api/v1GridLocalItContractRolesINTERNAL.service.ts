...
export interface GetSingleGridLocalItContractRolesGetByOrganizationUuidRequestParams {
...
export class APIV1GridLocalItContractRolesINTERNALService {
    ...
    public getSingleGridLocalItContractRolesGetAccessRightsForEntityById(requestParameters: GetSingleGridLocalItContractRolesGetAccessRightsForEntityByIdRequestParams, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json' | 'text/json', context?: HttpContext}): Observable<any> {
        ...
        let localVarPath = `/api/GridLocalItContractRoles/${this.configuration.encodeParam({name: "id", value: id, in: "path", style: "simple", explode: false, dataType: "number", dataFormat: "int32"})}`;
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getSingleGridLocalItContractRolesGetByOrganizationUuid(requestParameters: GetSingleGridLocalItContractRolesGetByOrganizationUuidRequestParams, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'text/json', context?: HttpContext}): Observable<object>;
    public getSingleGridLocalItContractRolesGetByOrganizationUuid(requestParameters: GetSingleGridLocalItContractRolesGetByOrganizationUuidRequestParams, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'text/json', context?: HttpContext}): Observable<HttpResponse<object>>;
    public getSingleGridLocalItContractRolesGetByOrganizationUuid(requestParameters: GetSingleGridLocalItContractRolesGetByOrganizationUuidRequestParams, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'text/json', context?: HttpContext}): Observable<HttpEvent<object>>;
    public getSingleGridLocalItContractRolesGetByOrganizationUuid(requestParameters: GetSingleGridLocalItContractRolesGetByOrganizationUuidRequestParams, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json' | 'text/json', context?: HttpContext}): Observable<any> {
        const organizationUuid = requestParameters.organizationUuid;
        if (organizationUuid === null || organizationUuid === undefined) {
            throw new Error('Required parameter organizationUuid was null or undefined when calling getSingleGridLocalItContractRolesGetByOrganizationUuid.');
        }
        ...
        let localVarPath = `/api/GridLocalItContractRoles`;
        return this.httpClient.request<object>('get', `${this.configuration.basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
                params: localVarQueryParameters,
