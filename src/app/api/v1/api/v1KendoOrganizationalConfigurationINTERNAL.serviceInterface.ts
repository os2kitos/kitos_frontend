...
export interface APIV1KendoOrganizationalConfigurationINTERNALServiceInterface {
     ...
     */
    gETKendoOrganizationalConfigurationGetAccessRightsForEntityInt32IdNullable1GetEntityAccessRightsById(id: number, getEntityAccessRights: boolean, extraHttpRequestParams?: any): Observable<object>;
