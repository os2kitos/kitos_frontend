...
export interface APIV1ODATADataProcessingRegistrationReadModelsINTERNALServiceInterface {
     ...
     */
    gETDataProcessingRegistrationReadModelsGetInt32OrganizationIdByOrganizationid(organizationId: number, $expand?: string, $select?: string, extraHttpRequestParams?: any): Observable<object>;
