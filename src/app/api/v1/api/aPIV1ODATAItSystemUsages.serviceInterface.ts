...
import { ItSystemUsageIEnumerableODataResponse } from '../model/models';
...
export interface APIV1ODATAItSystemUsagesServiceInterface {
     ...
     */
    gETItSystemUsagesGet($expand?: string, $filter?: string, $select?: string, $orderby?: string, $top?: number, $skip?: number, $count?: boolean, extraHttpRequestParams?: any): Observable<object>;
     ...
     * @param $select Selects which properties to include in the response.
     */
    gETItSystemUsagesGetInt32KeyById(id: number, $expand?: string, $select?: string, extraHttpRequestParams?: any): Observable<object>;
     ...
     * @param $count Includes a count of the matching results in the response.
     */
    gETItSystemUsagesGetItSystemsInt32OrgKeyByOrgkey(orgKey: number, $expand?: string, $filter?: string, $select?: string, $orderby?: string, $top?: number, $skip?: number, $count?: boolean, extraHttpRequestParams?: any): Observable<ItSystemUsageIEnumerableODataResponse>;
