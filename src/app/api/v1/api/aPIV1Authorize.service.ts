...
// @ts-ignore
import { OrganizationAndDefaultUnitDTOApiReturnDTO } from '../model/organizationAndDefaultUnitDTOApiReturnDTO';
// @ts-ignore
import { OrganizationSimpleDTOIEnumerableApiReturnDTO } from '../model/organizationSimpleDTOIEnumerableApiReturnDTO';
// @ts-ignore
import { UserDTOApiReturnDTO } from '../model/userDTOApiReturnDTO';
...
} from './aPIV1Authorize.serviceInterface';
...
export class APIV1AuthorizeService implements APIV1AuthorizeServiceInterface {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public gETAuthorizeGetLogin(observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'text/json', context?: HttpContext}): Observable<UserDTOApiReturnDTO>;
    public gETAuthorizeGetLogin(observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'text/json', context?: HttpContext}): Observable<HttpResponse<UserDTOApiReturnDTO>>;
    public gETAuthorizeGetLogin(observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'text/json', context?: HttpContext}): Observable<HttpEvent<UserDTOApiReturnDTO>>;
    public gETAuthorizeGetLogin(observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json' | 'text/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.request<UserDTOApiReturnDTO>('get', `${this.configuration.basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public gETAuthorizeGetOrganizationInt32OrgId(orgId: number, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'text/json', context?: HttpContext}): Observable<OrganizationAndDefaultUnitDTOApiReturnDTO>;
    public gETAuthorizeGetOrganizationInt32OrgId(orgId: number, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'text/json', context?: HttpContext}): Observable<HttpResponse<OrganizationAndDefaultUnitDTOApiReturnDTO>>;
    public gETAuthorizeGetOrganizationInt32OrgId(orgId: number, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'text/json', context?: HttpContext}): Observable<HttpEvent<OrganizationAndDefaultUnitDTOApiReturnDTO>>;
    public gETAuthorizeGetOrganizationInt32OrgId(orgId: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json' | 'text/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.request<OrganizationAndDefaultUnitDTOApiReturnDTO>('get', `${this.configuration.basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public gETAuthorizeGetOrganizationsStringOrderByNullable1OrderByAsc(orderBy?: string, orderByAsc?: boolean, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'text/json', context?: HttpContext}): Observable<OrganizationSimpleDTOIEnumerableApiReturnDTO>;
    public gETAuthorizeGetOrganizationsStringOrderByNullable1OrderByAsc(orderBy?: string, orderByAsc?: boolean, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'text/json', context?: HttpContext}): Observable<HttpResponse<OrganizationSimpleDTOIEnumerableApiReturnDTO>>;
    public gETAuthorizeGetOrganizationsStringOrderByNullable1OrderByAsc(orderBy?: string, orderByAsc?: boolean, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'text/json', context?: HttpContext}): Observable<HttpEvent<OrganizationSimpleDTOIEnumerableApiReturnDTO>>;
    public gETAuthorizeGetOrganizationsStringOrderByNullable1OrderByAsc(orderBy?: string, orderByAsc?: boolean, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json' | 'text/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.request<OrganizationSimpleDTOIEnumerableApiReturnDTO>('get', `${this.configuration.basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
                params: localVarQueryParameters,
                responseType: <any>responseType_,
