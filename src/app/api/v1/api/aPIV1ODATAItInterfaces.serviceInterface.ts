...
import { ItInterfaceIQueryableODataResponse } from '../model/models';
import { ItInterfaceODataResponse } from '../model/models';
...
export interface APIV1ODATAItInterfacesServiceInterface {
     ...
     */
    gETItInterfacesGet($expand?: string, $filter?: string, $select?: string, $orderby?: string, $top?: number, $skip?: number, $count?: boolean, extraHttpRequestParams?: any): Observable<ItInterfaceODataResponse>;
     ...
     * @param $select Selects which properties to include in the response.
     */
    gETItInterfacesGetInt32KeyById(id: number, $expand?: string, $select?: string, extraHttpRequestParams?: any): Observable<object>;
     ...
     * @param $count Includes a count of the matching results in the response.
     */
    gETItInterfacesGetItInterfacesInt32KeyByKey(key: number, $expand?: string, $filter?: string, $select?: string, $orderby?: string, $top?: number, $skip?: number, $count?: boolean, extraHttpRequestParams?: any): Observable<ItInterfaceIQueryableODataResponse>;
