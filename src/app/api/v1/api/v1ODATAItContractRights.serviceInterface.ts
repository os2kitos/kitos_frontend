...
export interface APIV1ODATAItContractRightsServiceInterface {
     ...
     * @param $count Includes a count of the matching results in the response.
     */
    gETItContractRightsGetByUserInt32UserId(userId: number, $expand?: string, $filter?: string, $select?: string, $orderby?: string, $top?: number, $skip?: number, $count?: boolean, extraHttpRequestParams?: any): Observable<APIItContractRightIQueryableODataResponse>;
