...
// @ts-ignore
import { EconomyStreamDTOIEnumerableApiReturnDTO } from '../model/economyStreamDTOIEnumerableApiReturnDTO';
...
} from './aPIV1EconomyStream.serviceInterface';
...
export class APIV1EconomyStreamService implements APIV1EconomyStreamServiceInterface {
     ...
     */
    public gETEconomyStreamGetExternEconomyStreamForContractInt32ExternPaymentForContractWithId(externPaymentForContractWithId: number, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'text/json', context?: HttpContext}): Observable<EconomyStreamDTOIEnumerableApiReturnDTO>;
    public gETEconomyStreamGetExternEconomyStreamForContractInt32ExternPaymentForContractWithId(externPaymentForContractWithId: number, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'text/json', context?: HttpContext}): Observable<HttpResponse<EconomyStreamDTOIEnumerableApiReturnDTO>>;
    public gETEconomyStreamGetExternEconomyStreamForContractInt32ExternPaymentForContractWithId(externPaymentForContractWithId: number, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'text/json', context?: HttpContext}): Observable<HttpEvent<EconomyStreamDTOIEnumerableApiReturnDTO>>;
    public gETEconomyStreamGetExternEconomyStreamForContractInt32ExternPaymentForContractWithId(externPaymentForContractWithId: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json' | 'text/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.request<EconomyStreamDTOIEnumerableApiReturnDTO>('get', `${this.configuration.basePath}${localVarPath}`,
            {
