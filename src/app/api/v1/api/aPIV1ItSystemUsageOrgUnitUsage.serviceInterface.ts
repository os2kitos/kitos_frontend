...
import { SimpleOrgUnitDTOIEnumerableApiReturnDTO } from '../model/models';
...
export interface APIV1ItSystemUsageOrgUnitUsageServiceInterface {
     ...
     * @param id 
     */
    gETItSystemUsageOrgUnitUsageGetOrgUnitsBySystemUsageInt32Id(id: number, extraHttpRequestParams?: any): Observable<SimpleOrgUnitDTOIEnumerableApiReturnDTO>;
