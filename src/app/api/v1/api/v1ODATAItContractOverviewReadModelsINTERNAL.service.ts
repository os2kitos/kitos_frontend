...
export class APIV1ODATAItContractOverviewReadModelsINTERNALService {
    ...
    public getSingleItContractOverviewReadModelsGetByOrganizationid(requestParameters: GetSingleItContractOverviewReadModelsGetByOrganizationidRequestParams, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.request<APIItContractOverviewReadModelODataListResponse>('get', `${this.configuration.basePath}${localVarPath}`,
            {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getSingleItContractOverviewReadModelsGetByUuid(requestParameters: GetSingleItContractOverviewReadModelsGetByUuidRequestParams, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*', context?: HttpContext}): Observable<APIItContractOverviewReadModelODataListResponse>;
    public getSingleItContractOverviewReadModelsGetByUuid(requestParameters: GetSingleItContractOverviewReadModelsGetByUuidRequestParams, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*', context?: HttpContext}): Observable<HttpResponse<APIItContractOverviewReadModelODataListResponse>>;
    public getSingleItContractOverviewReadModelsGetByUuid(requestParameters: GetSingleItContractOverviewReadModelsGetByUuidRequestParams, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*', context?: HttpContext}): Observable<HttpEvent<APIItContractOverviewReadModelODataListResponse>>;
    public getSingleItContractOverviewReadModelsGetByUuid(requestParameters: GetSingleItContractOverviewReadModelsGetByUuidRequestParams, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*', context?: HttpContext}): Observable<any> {
        const organizationUuid = requestParameters.organizationUuid;
        if (organizationUuid === null || organizationUuid === undefined) {
            throw new Error('Required parameter organizationUuid was null or undefined when calling getSingleItContractOverviewReadModelsGetByUuid.');
        }
