...
export interface APIV1ExcelINTERNALServiceInterface {
     ...
     */
    gETExcelGetAccessRightsForEntityInt32IdNullable1GetEntityAccessRightsById(id: number, getEntityAccessRights: boolean, extraHttpRequestParams?: any): Observable<object>;
