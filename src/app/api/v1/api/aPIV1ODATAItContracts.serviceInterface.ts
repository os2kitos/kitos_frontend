...
import { ItContractIQueryableODataResponse } from '../model/models';
...
export interface APIV1ODATAItContractsServiceInterface {
     ...
     */
    gETItContractsGet($expand?: string, $filter?: string, $select?: string, $orderby?: string, $top?: number, $skip?: number, $count?: boolean, extraHttpRequestParams?: any): Observable<ItContractIQueryableODataResponse>;
     ...
     * @param $select Selects which properties to include in the response.
     */
    gETItContractsGetInt32KeyById(id: number, $expand?: string, $select?: string, extraHttpRequestParams?: any): Observable<object>;
     ...
     * @param $count Includes a count of the matching results in the response.
     */
    gETItContractsGetItContractsInt32KeyByKey(key: number, $expand?: string, $filter?: string, $select?: string, $orderby?: string, $top?: number, $skip?: number, $count?: boolean, extraHttpRequestParams?: any): Observable<ItContractIQueryableODataResponse>;
