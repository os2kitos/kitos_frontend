...
export interface APIV1ItContractRightServiceInterface {
     ...
     */
    dELETEItContractRightDeleteInt32IdInt32OrganizationIdInt32RIdInt32UIdById(id: number, rId: number, uId: number, organizationId: number, extraHttpRequestParams?: any): Observable<object>;
     ...
     * @param organizationId 
     */
    gETItContractRightGetAccessRightsInt32OrganizationIdNullable1GetEntitiesAccessRights(getEntitiesAccessRights: boolean, organizationId: number, extraHttpRequestParams?: any): Observable<object>;
     ...
     */
    pOSTItContractRightPostRightRightInputDTODtoInt32IdInt32OrganizationIdById(id: number, organizationId: number, dto: APIRightInputDTO, extraHttpRequestParams?: any): Observable<object>;
     ...
     * @param ids 
     */
    pOSTItContractRightPostSearchAccessRightsForEntityListInt32IdsNullable1GetEntityListAccessRights(getEntityListAccessRights: boolean, ids: Array<number>, extraHttpRequestParams?: any): Observable<object>;
