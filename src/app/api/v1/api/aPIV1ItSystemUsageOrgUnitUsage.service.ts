...
// @ts-ignore
import { SimpleOrgUnitDTOIEnumerableApiReturnDTO } from '../model/simpleOrgUnitDTOIEnumerableApiReturnDTO';

// @ts-ignore
import { BASE_PATH, COLLECTION_FORMATS }                     from '../variables';
import { Configuration }                                     from '../configuration';
import {
    APIV1ItSystemUsageOrgUnitUsageServiceInterface
} from './aPIV1ItSystemUsageOrgUnitUsage.serviceInterface';
...
export class APIV1ItSystemUsageOrgUnitUsageService implements APIV1ItSystemUsageOrgUnitUsageServiceInterface {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public gETItSystemUsageOrgUnitUsageGetOrgUnitsBySystemUsageInt32Id(id: number, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'text/json', context?: HttpContext}): Observable<SimpleOrgUnitDTOIEnumerableApiReturnDTO>;
    public gETItSystemUsageOrgUnitUsageGetOrgUnitsBySystemUsageInt32Id(id: number, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'text/json', context?: HttpContext}): Observable<HttpResponse<SimpleOrgUnitDTOIEnumerableApiReturnDTO>>;
    public gETItSystemUsageOrgUnitUsageGetOrgUnitsBySystemUsageInt32Id(id: number, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'text/json', context?: HttpContext}): Observable<HttpEvent<SimpleOrgUnitDTOIEnumerableApiReturnDTO>>;
    public gETItSystemUsageOrgUnitUsageGetOrgUnitsBySystemUsageInt32Id(id: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json' | 'text/json', context?: HttpContext}): Observable<any> {
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling gETItSystemUsageOrgUnitUsageGetOrgUnitsBySystemUsageInt32Id.');
        }
        ...
        return this.httpClient.request<SimpleOrgUnitDTOIEnumerableApiReturnDTO>('get', `${this.configuration.basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
