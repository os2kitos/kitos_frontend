...
import { APILocalRelationFrequencyType } from '../model/models';
...
export interface APIV1ODATALocalFrequencyTypesINTERNALServiceInterface {
     ...
     * @param key 
     */
    dELETELocalFrequencyTypesDeleteInt32KeyInt32OrganizationId(organizationId: number, key: number, extraHttpRequestParams?: any): Observable<object>;
     ...
     */
    gETLocalFrequencyTypesGetByOrganizationIdInt32OrganizationId(organizationId: number, $expand?: string, $select?: string, extraHttpRequestParams?: any): Observable<object>;
     ...
     * @param delta 
     */
    pATCHLocalFrequencyTypesPatchDelta1DeltaInt32KeyInt32OrganizationId(organizationId: number, key: number, delta: APILocalRelationFrequencyType, extraHttpRequestParams?: any): Observable<object>;
     ...
     * @param entity 
     */
    pOSTLocalFrequencyTypesPostLocalRelationFrequencyTypeEntityInt32OrganizationId(organizationId: number, entity: APILocalRelationFrequencyType, extraHttpRequestParams?: any): Observable<object>;
