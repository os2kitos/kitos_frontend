...
export class APIV1UserRolesManagementINTERNALService {
     ...
     */
    public getSingleUserRolesManagementGet(requestParameters: GetSingleUserRolesManagementGetRequestParams, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'text/json', context?: HttpContext}): Observable<object>;
    public getSingleUserRolesManagementGet(requestParameters: GetSingleUserRolesManagementGetRequestParams, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'text/json', context?: HttpContext}): Observable<HttpResponse<object>>;
    public getSingleUserRolesManagementGet(requestParameters: GetSingleUserRolesManagementGetRequestParams, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'text/json', context?: HttpContext}): Observable<HttpEvent<object>>;
    public getSingleUserRolesManagementGet(requestParameters: GetSingleUserRolesManagementGetRequestParams, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json' | 'text/json', context?: HttpContext}): Observable<any> {
        const organizationId = requestParameters.organizationId;
        if (organizationId === null || organizationId === undefined) {
            throw new Error('Required parameter organizationId was null or undefined when calling getSingleUserRolesManagementGet.');
        }
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getSingleUserRolesManagementGetAccessRightsForEntity(requestParameters: GetSingleUserRolesManagementGetAccessRightsForEntityRequestParams, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'text/json', context?: HttpContext}): Observable<object>;
    public getSingleUserRolesManagementGetAccessRightsForEntity(requestParameters: GetSingleUserRolesManagementGetAccessRightsForEntityRequestParams, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'text/json', context?: HttpContext}): Observable<HttpResponse<object>>;
    public getSingleUserRolesManagementGetAccessRightsForEntity(requestParameters: GetSingleUserRolesManagementGetAccessRightsForEntityRequestParams, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'text/json', context?: HttpContext}): Observable<HttpEvent<object>>;
    public getSingleUserRolesManagementGetAccessRightsForEntity(requestParameters: GetSingleUserRolesManagementGetAccessRightsForEntityRequestParams, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json' | 'text/json', context?: HttpContext}): Observable<any> {
        const id = requestParameters.id;
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling getSingleUserRolesManagementGetAccessRightsForEntity.');
        }
        ...
        if (getEntityAccessRights === null || getEntityAccessRights === undefined) {
            throw new Error('Required parameter getEntityAccessRights was null or undefined when calling getSingleUserRolesManagementGetAccessRightsForEntity.');
        }
