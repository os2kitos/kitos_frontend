...
// @ts-ignore
import { DataProcessingRegistrationRightIQueryableODataResponse } from '../model/dataProcessingRegistrationRightIQueryableODataResponse';

// @ts-ignore
import { BASE_PATH, COLLECTION_FORMATS }                     from '../variables';
import { Configuration }                                     from '../configuration';
import {
    APIV1ODATADataProcessingRegistrationRightsServiceInterface
} from './aPIV1ODATADataProcessingRegistrationRights.serviceInterface';
...
export class APIV1ODATADataProcessingRegistrationRightsService implements APIV1ODATADataProcessingRegistrationRightsServiceInterface {
     ...
     */
    public gETDataProcessingRegistrationRightsGetByUserInt32UserId(userId: number, $expand?: string, $filter?: string, $select?: string, $orderby?: string, $top?: number, $skip?: number, $count?: boolean, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*', context?: HttpContext}): Observable<DataProcessingRegistrationRightIQueryableODataResponse>;
    public gETDataProcessingRegistrationRightsGetByUserInt32UserId(userId: number, $expand?: string, $filter?: string, $select?: string, $orderby?: string, $top?: number, $skip?: number, $count?: boolean, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*', context?: HttpContext}): Observable<HttpResponse<DataProcessingRegistrationRightIQueryableODataResponse>>;
    public gETDataProcessingRegistrationRightsGetByUserInt32UserId(userId: number, $expand?: string, $filter?: string, $select?: string, $orderby?: string, $top?: number, $skip?: number, $count?: boolean, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*', context?: HttpContext}): Observable<HttpEvent<DataProcessingRegistrationRightIQueryableODataResponse>>;
    public gETDataProcessingRegistrationRightsGetByUserInt32UserId(userId: number, $expand?: string, $filter?: string, $select?: string, $orderby?: string, $top?: number, $skip?: number, $count?: boolean, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.request<DataProcessingRegistrationRightIQueryableODataResponse>('get', `${this.configuration.basePath}${localVarPath}`,
            {
