...
// @ts-ignore
import { ItContractIQueryableODataResponse } from '../model/itContractIQueryableODataResponse';

// @ts-ignore
import { BASE_PATH, COLLECTION_FORMATS }                     from '../variables';
import { Configuration }                                     from '../configuration';
import {
    APIV1ODATAItContractsServiceInterface
} from './aPIV1ODATAItContracts.serviceInterface';
...
export class APIV1ODATAItContractsService implements APIV1ODATAItContractsServiceInterface {
     ...
     */
    public gETItContractsGet($expand?: string, $filter?: string, $select?: string, $orderby?: string, $top?: number, $skip?: number, $count?: boolean, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*', context?: HttpContext}): Observable<ItContractIQueryableODataResponse>;
    public gETItContractsGet($expand?: string, $filter?: string, $select?: string, $orderby?: string, $top?: number, $skip?: number, $count?: boolean, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*', context?: HttpContext}): Observable<HttpResponse<ItContractIQueryableODataResponse>>;
    public gETItContractsGet($expand?: string, $filter?: string, $select?: string, $orderby?: string, $top?: number, $skip?: number, $count?: boolean, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*', context?: HttpContext}): Observable<HttpEvent<ItContractIQueryableODataResponse>>;
    public gETItContractsGet($expand?: string, $filter?: string, $select?: string, $orderby?: string, $top?: number, $skip?: number, $count?: boolean, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.request<ItContractIQueryableODataResponse>('get', `${this.configuration.basePath}${localVarPath}`,
            {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public gETItContractsGetItContractsInt32KeyByKey(key: number, $expand?: string, $filter?: string, $select?: string, $orderby?: string, $top?: number, $skip?: number, $count?: boolean, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*', context?: HttpContext}): Observable<ItContractIQueryableODataResponse>;
    public gETItContractsGetItContractsInt32KeyByKey(key: number, $expand?: string, $filter?: string, $select?: string, $orderby?: string, $top?: number, $skip?: number, $count?: boolean, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*', context?: HttpContext}): Observable<HttpResponse<ItContractIQueryableODataResponse>>;
    public gETItContractsGetItContractsInt32KeyByKey(key: number, $expand?: string, $filter?: string, $select?: string, $orderby?: string, $top?: number, $skip?: number, $count?: boolean, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*', context?: HttpContext}): Observable<HttpEvent<ItContractIQueryableODataResponse>>;
