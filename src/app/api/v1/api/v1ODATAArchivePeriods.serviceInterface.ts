...
export interface APIV1ODATAArchivePeriodsServiceInterface {
     ...
     */
    gETArchivePeriodsGet($expand?: string, $filter?: string, $select?: string, $orderby?: string, $top?: number, $skip?: number, $count?: boolean, extraHttpRequestParams?: any): Observable<object>;
     ...
     * @param $select Selects which properties to include in the response.
     */
    gETArchivePeriodsGetArchivePeriodsForItSystemUsageInt32OrganizationIdInt32SystemUsageIdByOrganizationidAndSystemusageid(organizationId: number, systemUsageId: number, $expand?: string, $select?: string, extraHttpRequestParams?: any): Observable<object>;
