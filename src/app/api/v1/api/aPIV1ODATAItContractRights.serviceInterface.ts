...
import { ItContractRightIQueryableODataResponse } from '../model/models';
...
export interface APIV1ODATAItContractRightsServiceInterface {
     ...
     */
    gETItContractRightsGet($expand?: string, $filter?: string, $select?: string, $orderby?: string, $top?: number, $skip?: number, $count?: boolean, extraHttpRequestParams?: any): Observable<object>;
     ...
     * @param $count Includes a count of the matching results in the response.
     */
    gETItContractRightsGetByUserInt32UserId(userId: number, $expand?: string, $filter?: string, $select?: string, $orderby?: string, $top?: number, $skip?: number, $count?: boolean, extraHttpRequestParams?: any): Observable<ItContractRightIQueryableODataResponse>;
