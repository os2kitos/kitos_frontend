...
// @ts-ignore
import { APIOrganizationUnitRole } from '../model/aPIOrganizationUnitRole';

// @ts-ignore
import { BASE_PATH, COLLECTION_FORMATS }                     from '../variables';
import { Configuration }                                     from '../configuration';
import {
    APIV1ODATAOrganizationUnitRolesINTERNALServiceInterface
} from './v1ODATAOrganizationUnitRolesINTERNAL.serviceInterface';
...
export class APIV1ODATAOrganizationUnitRolesINTERNALService implements APIV1ODATAOrganizationUnitRolesINTERNALServiceInterface {
    ...
    /**
     * Update entity in EntitySet OrganizationUnitRoles
     * @param id key: Id
     * @param organizationUnitRole The entity to patch
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public pATCHOrganizationUnitRolesPatchDelta1DeltaInt32KeyById(id: number, organizationUnitRole: APIOrganizationUnitRole, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<object>;
    public pATCHOrganizationUnitRolesPatchDelta1DeltaInt32KeyById(id: number, organizationUnitRole: APIOrganizationUnitRole, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<object>>;
    public pATCHOrganizationUnitRolesPatchDelta1DeltaInt32KeyById(id: number, organizationUnitRole: APIOrganizationUnitRole, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<object>>;
    public pATCHOrganizationUnitRolesPatchDelta1DeltaInt32KeyById(id: number, organizationUnitRole: APIOrganizationUnitRole, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling pATCHOrganizationUnitRolesPatchDelta1DeltaInt32KeyById.');
        }
        if (organizationUnitRole === null || organizationUnitRole === undefined) {
            throw new Error('Required parameter organizationUnitRole was null or undefined when calling pATCHOrganizationUnitRolesPatchDelta1DeltaInt32KeyById.');
        }
