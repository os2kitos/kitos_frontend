...
export interface APIV1ODATAOrganizationUnitsINTERNALServiceInterface {
     ...
     */
    gETOrganizationUnitsGetInt32KeyById(id: number, $expand?: string, $select?: string, extraHttpRequestParams?: any): Observable<object>;
     ...
     */
    gETOrganizationUnitsGetOrganizationUnits($expand?: string, $filter?: string, $select?: string, $orderby?: string, $top?: number, $skip?: number, $count?: boolean, extraHttpRequestParams?: any): Observable<object>;
     ...
     * @param $select Selects which properties to include in the response.
     */
    gETOrganizationUnitsGetOrganizationUnitsInt32OrgKeyByOrgkey(orgKey: number, $expand?: string, $select?: string, extraHttpRequestParams?: any): Observable<object>;
