...
export interface APIV1ODATAUsersINTERNALServiceInterface {
     ...
     */
    gETUsersGet($expand?: string, $filter?: string, $select?: string, $orderby?: string, $top?: number, $skip?: number, $count?: boolean, extraHttpRequestParams?: any): Observable<object>;
     ...
     * @param $select Selects which properties to include in the response.
     */
    gETUsersGetInt32KeyById(id: number, $expand?: string, $select?: string, extraHttpRequestParams?: any): Observable<object>;
     ...
     */
    gETUsersGetUserByEmailStringEmail(email: string, extraHttpRequestParams?: any): Observable<object>;
