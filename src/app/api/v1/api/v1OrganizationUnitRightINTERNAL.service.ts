...
export class APIV1OrganizationUnitRightINTERNALService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getSingleOrganizationUnitRightGetRightsV1(requestParameters: GetSingleOrganizationUnitRightGetRightsV1RequestParams, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'text/json', context?: HttpContext}): Observable<object>;
    public getSingleOrganizationUnitRightGetRightsV1(requestParameters: GetSingleOrganizationUnitRightGetRightsV1RequestParams, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'text/json', context?: HttpContext}): Observable<HttpResponse<object>>;
    public getSingleOrganizationUnitRightGetRightsV1(requestParameters: GetSingleOrganizationUnitRightGetRightsV1RequestParams, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'text/json', context?: HttpContext}): Observable<HttpEvent<object>>;
    public getSingleOrganizationUnitRightGetRightsV1(requestParameters: GetSingleOrganizationUnitRightGetRightsV1RequestParams, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json' | 'text/json', context?: HttpContext}): Observable<any> {
        const id = requestParameters.id;
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling getSingleOrganizationUnitRightGetRightsV1.');
        }
        const paged = requestParameters.paged;
        if (paged === null || paged === undefined) {
            throw new Error('Required parameter paged was null or undefined when calling getSingleOrganizationUnitRightGetRightsV1.');
        }
