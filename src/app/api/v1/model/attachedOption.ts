...
export namespace APIAttachedOption {
    ...
    export type OptionTypeEnum = 'SENSITIVEPERSONALDATA' | 'REGISTERTYPEDATA';
    export const OptionTypeEnum = {
        Sensitivepersonaldata: 'SENSITIVEPERSONALDATA' as OptionTypeEnum,
        Registertypedata: 'REGISTERTYPEDATA' as OptionTypeEnum
    };
}
