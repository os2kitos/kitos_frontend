...
export interface YesNoIrrelevantOptionSingleValueDTO { 
    value?: YesNoIrrelevantOptionSingleValueDTO.ValueEnum;
}
export namespace YesNoIrrelevantOptionSingleValueDTO {
