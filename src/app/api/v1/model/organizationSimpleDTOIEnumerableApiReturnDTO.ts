 ...
 */
import { OrganizationSimpleDTO } from './organizationSimpleDTO';


export interface OrganizationSimpleDTOIEnumerableApiReturnDTO { 
    msg?: string;
    response?: Array<OrganizationSimpleDTO>;
}
