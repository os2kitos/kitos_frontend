...
import { APIV2ItContractInternalINTERNALService, APIV2ItContractService } from 'src/app/api/v2';
...
export class ITContractEffects {
    ...
    return this.actions$.pipe(
      ...
      mergeMap(([{ userUuid, roleUuid }, contractUuid]) =>
        this.apiInternalItContractService
          .patchSingleItContractInternalV2PatchAddRoleAssignmentByContractuuid({
  ...
  removeItContractRole$ = createEffect(() => {
    return this.actions$.pipe(
      ...
      mergeMap(([{ userUuid, roleUuid }, contractUuid]) =>
        this.apiInternalItContractService
          .patchSingleItContractInternalV2PatchRemoveRoleAssignmentByContractuuid({
            contractUuid: contractUuid,
            request: { userUuid: userUuid, roleUuid: roleUuid },
          })
          .pipe(
