...
export const selectInterfaceHasReadPermission = createSelector(selectITInterfaceState, (state) => state.permissions?.read);
export const selectInterfaceHasModifyPermission = createSelector(selectITInterfaceState, (state) => state.permissions?.modify);
export const selectInterfaceHasDeletePermission = createSelector(selectITInterfaceState, (state) => state.permissions?.delete);
export const selectInterfaceDeletionConflicts = createSelector(selectITInterfaceState, (state) => state.permissions?.deletionConflicts);
export const selectInterfaceHasCreateCollectionPermission = createSelector(selectITInterfaceState, (state) => state.collectionPermissions?.create);
