export const uiConfigHelpTexts = {
  cannotChangeTab: $localize`Det er ikke muligt at slå dette faneblad fra`,
  ...
  subtreeIsCompleteHelpText: $localize`Fanebladdet slås fra hvis alle felter/grupper fjernes, da siden ellers vil være uden indhold.`,
};
