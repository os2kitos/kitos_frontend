...
import { selectItSystemUsageGdprDataSensitivityLevels, selectItSystemUsageGdprSensitivePersonalData, selectItSystemUsageGdprSpecificPersonalData } from 'src/app/store/it-system-usage/selectors';
...
export class DataSensitivitySectionComponent extends BaseComponent implements OnInit {
  ...
  public readonly dataSensitivityLevels$ = this.store.select(selectItSystemUsageGdprDataSensitivityLevels).pipe(filterNullish());
  public readonly specificPersonalData$ = this.store.select(selectItSystemUsageGdprSpecificPersonalData).pipe(filterNullish());
  public readonly sensitivePersonalData$ = this.store.select(selectItSystemUsageGdprSensitivePersonalData).pipe(filterNullish());
  ...
  public patchDataSensitivityLevels(valueChange?: ValidatedValueChange<unknown>) {
    ...
    this.patchCheckboxFormData<APIGDPRWriteRequestDTO.DataSensitivityLevelsEnum>(this.dataSensitivityLevelForm, this.dataSensitivityLevelsDtoField, valueChange, dataSensitivityLevelEnums);
  ...
  public patchSpecificPersonalData(valueChange?: ValidatedValueChange<unknown>) {
    ...
    this.patchCheckboxFormData<APIGDPRWriteRequestDTO.SpecificPersonalDataEnum>(this.specificPersonalDataForm, this.specificPersonalDataDtoField, valueChange, specificPersonalDataEnums);
  }
  ...
  private patchCheckboxFormData<T>(form: FormGroup, dtoField: string,  valueChange?: ValidatedValueChange<unknown>, options?: T[]){
