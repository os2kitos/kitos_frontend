...
export class ITContractsComponent extends BaseComponent implements OnInit {
  ...
  public readonly gridColumns: GridColumn[] = [
    { field: 'name', title: $localize`IT Kontrakt`, style: 'primary', hidden: false },
    { field: 'disabled', title: $localize`IT Kontrakt status`, filter: 'boolean', style: 'chip', hidden: false },
